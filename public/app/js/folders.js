...
$(document).on('contextmenu', '[data-file-icon]:not(.show-up)', function(e) {
    ...
    $(this).append('<div class="append-option-box" style="top:' + topPos + 'px;left:' + leftPos + 'px;"><div class="inner-contenxt-box"><div data-function="data-rename">Rename</div> <div data-function="data-delete">Delete</div></div></div>');
